...
bool HelloWorld::init() {
	...
	unsigned long f = 1024 * 20;
	unsigned char *t =
	    CCFileUtils::sharedFileUtils()->getFileData("cthulfu1.ctf", "r", &f);
	std::string pLoadString((const char *)t, f);

	Context *context = NULL;
	Node *programNode = NULL;
	try {
		context = new Context(pLoadString.c_str());
